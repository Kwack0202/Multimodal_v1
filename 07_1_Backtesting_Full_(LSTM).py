...
for ticker in tickers:
    for day in days:
        ...
        for time_step in time_steps:
            ...
            output_dir = './Backtesting/trading_signal/full_period/LSTM'
            os.makedirs(output_dir, exist_ok=True) 
            trading_data.to_csv(f'./Backtesting/trading_signal/full_period/LSTM/{ticker}_{day}_signal.csv', index=True)
