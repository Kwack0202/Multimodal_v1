...
for ticker in tickers:
    ...
    LSTM_5 = pd.read_csv(f'./Backtesting/Final_results/full_period/{ticker}_LSTM_5day_5.csv', index_col=0)
    LSTM_20 = pd.read_csv(f'./Backtesting/Final_results/full_period/{ticker}_LSTM_5day_20.csv', index_col=0)
    LSTM_60 = pd.read_csv(f'./Backtesting/Final_results/full_period/{ticker}_LSTM_5day_60.csv', index_col=0)
    LSTM_120 = pd.read_csv(f'./Backtesting/Final_results/full_period/{ticker}_LSTM_5day_120.csv', index_col=0)
        
    VIT_5 = pd.read_csv(f'./Backtesting/Final_results/full_period/{ticker}_VIT_5day_5.csv', index_col=0)
    VIT_20 = pd.read_csv(f'./Backtesting/Final_results/full_period/{ticker}_VIT_5day_20.csv', index_col=0)
    VIT_60 = pd.read_csv(f'./Backtesting/Final_results/full_period/{ticker}_VIT_5day_60.csv', index_col=0)
    VIT_120 = pd.read_csv(f'./Backtesting/Final_results/full_period/{ticker}_VIT_5day_120.csv', index_col=0)
        
    if ticker == 'IXIC':
        Fusion_df = pd.read_csv('./Backtesting/Final_results/full_period/IXIC_Fusion_hard_5day_lgb.csv')
    
    elif ticker == 'US500' :
        Fusion_df = pd.read_csv('./Backtesting/Final_results/full_period/US500_Fusion_hard_5day_lgb.csv')
    
    elif ticker == 'KS11' :
        Fusion_df = pd.read_csv('./Backtesting/Final_results/full_period/KS11_Fusion_hard_5day_SVM.csv')
    
    else:
        Fusion_df = pd.read_csv('./Backtesting/Final_results/full_period/KQ11_Fusion_soft_5day_xgb.csv')
        

    # 각 데이터 프레임의 Cumulative_Profit을 추출합니다.
    cumulative_profits = {
    ...
    # 그림을 저장합니다.
    plt.savefig(os.path.join(output_directory, f'{ticker}_5day_cum.png'))
