...
for ticker in tickers:
    ...
    for time_step in time_steps:
        ...
        for day in days:
            ...
            for model in models:
                df = pd.read_csv(f"./Backtesting/trading_signal/full_period/{model}/{ticker}_{day}_signal.csv", index_col=0)
                ...
                if not os.path.exists(f'./Backtesting/trading_results/full_period/{model}/'):
                    os.makedirs(f'./Backtesting/trading_results/full_period/{model}/')
                    
                merged_df.to_csv(f'./Backtesting/trading_results/full_period/{model}/{ticker}_{day}_{time_step}_signal.csv', index=True)