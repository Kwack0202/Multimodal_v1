    ...
    for day in days:
        ...
        for year in years:
            ...
            for time_step in time_steps:
                ...
                if not os.path.exists(f'./Backtesting/trading_signal/YOY_{year}/VIT/'):
                    os.makedirs(f'./Backtesting/trading_signal/YOY_{year}/VIT/')
               
                trading_df.to_csv(f'./Backtesting/trading_signal/YOY_{year}/VIT/{ticker}_{day}_signal.csv', index=True)